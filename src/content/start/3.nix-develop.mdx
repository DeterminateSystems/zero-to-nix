...
Now explore the Nix development environment for <Language /> by running <code>nix develop "github:DeterminateSystems/zero-to-nix#<span x-text="language.toLowerCase()" />"</code>.
