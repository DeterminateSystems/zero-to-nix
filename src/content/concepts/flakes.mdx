...
In [Determinate Nix][det-nix], the downstream distribution of Nix from [Determinate Systems][detsys] that you install at the begin of the [quick start][quick-start], flakes are [**considered stable**][stable-flakes], enabling you to use them out of the box.
