...
snippet: |
  The language you use to define Nix [package builds](/concepts/package), [development environments](/concepts/dev-env), [NixOS configurations](/concepts/nixos), and more.
