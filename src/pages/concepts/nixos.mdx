...
Everything[^1] in a NixOS system is configured using the [Nix language][lang] and the NixOS [module system](#modules).
Rather than installing [packages] in an ad hoc way, you can [declare][declarative] which specific system you'd like to have and Nix builds the system for you from the ground up.
