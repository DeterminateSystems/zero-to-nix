...
<Admonition warning open title="Flakes are experimental but nonetheless strongly recommended" id="flakes-warning" client:load>
...
<Admonition success title="Mental model" id="flakes-mental-model" open client:load>
...
[`https://flakehub.com/f/NixOS/nixpkgs/0.2305.*.tar.gz`][fh-nixpkgs] | The most recent revision of the [`nixos-23.05`][branch] branch of [Nixpkgs] hosted on [FlakeHub]
...
<Admonition info title="The `lib` convention" client:load>
...
[branch]: https://github.com/nixos/nixpkgs/tree/nixos-23.05
