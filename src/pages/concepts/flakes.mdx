...
<Admonition kind="warning" title="Flakes are experimental" id="flakes-warning" isOpen client:load>
...
A *flake reference* is a string representation of the location of a flake.
Here are some example flake references:

Reference | Description
:---------|:-----------
`github:DeterminateSystems/zero-to-nix` | Something
