...
A *Nix channel* is a mechanism used by the legacy Nix CLI to keep [Nixpkgs](/concepts/nixpkgs) up to date. In the new Nix CLI, it has been replaced by [flakes](/concepts/flakes).
...
More information about channels can be found in the [Nix manual](https://nixos.org/manual/nix/stable/command-ref/nix-channel).
