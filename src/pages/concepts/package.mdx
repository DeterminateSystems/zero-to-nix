...
Nix *packages* are self-contained bundles that are built using [derivations](/concepts/derivations) and provide some kind of software or dependencies of software on your computer.
