...
<Admonition type="warning" title="Don't try this in a container!" id="nix-installer-container">
Nix Installer makes some assumptions about your system that are unlikely to hold in a container environment.
In order to install and start the Nix daemon, for example, Nix Installer needs to have a service manager like [systemd] available, but service managers are superfluous in most containers.
</Admonition>
