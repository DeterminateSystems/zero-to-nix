...
We believe that Harmonic provides a better experience for people who are new to Nix than the [official Nix installer][official].
...
Harmonic improves on the official Nix installer by enabling you to uninstall Nix&mdash;and undo all of the system changes that Nix installation introduces&mdash;with a single command.
