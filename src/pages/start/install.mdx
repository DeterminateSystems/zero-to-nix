...
The easiest way to install Nix is to use [Nix installer][nix-installer], a tool from [Determinate Systems][detsys] that tailors the installation process to your system:
