...
Install Nix using [nix-installer], a tool from [Determinate Systems][detsys] that tailors the installation process to your system:
...
See the [Uninstalling Nix][uninstall] guide if you need to uninstall Nix or the [nix-installer] concept if you'd like more background.
</Admonition>
