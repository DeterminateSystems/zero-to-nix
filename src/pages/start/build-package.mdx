...
While [Nixpkgs] is by far the largest Nix package repository in the known universe, any [Nix flake][flake] can include package [outputs]. Let's build a Nix package from a different repo, this time [Home Manager][hm], a popular Nix tool for configuring home environments:
