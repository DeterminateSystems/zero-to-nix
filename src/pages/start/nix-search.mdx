...
While [Nixpkgs] is by far the largest Nix package collection&mdash;over 80,000 packages and counting 😎&mdash;any [Nix flake][flakes] can provide package [outputs].
