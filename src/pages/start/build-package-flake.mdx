...
Creating your own packages can be a bit tricky&mdash;though we hope this guide sets you in the right direction!&mdash;so we recommend resorting to that only when you:
...
[flake-py]: https://github.com/DeterminateSystems/zero-to-nix/tree/main/nix/templates/python/flake.nix
