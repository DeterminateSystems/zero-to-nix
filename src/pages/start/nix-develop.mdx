...
<Admonition type="warning" title="Load times" client:load>
The first time you activate a Nix development environment using `nix develop` it may take a while.
...
While it's fun to explore the environment, you don't always want to be inside the to use it.
