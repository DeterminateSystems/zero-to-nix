...
At the beginning of the Zero to Nix quick start, we [installed] Nix using the [Determinate Nix Installer][nix-installer], an unofficial tool from [Determinate Systems][ds].
