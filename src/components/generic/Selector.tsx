...
const Selector = ({ title, options, atom }: Props) => {
  ...
  return (
    <div className="not-prose inline-flex items-center space-x-6 border-2 rounded-xl py-4 px-6 shadow-sm bg-slate-50">
            ...
            <Tab as={Fragment}>
              <button
                ...
                className={clsx(
                  ...
                  $item === o
                    ? "bg-black text-white"
                    : "bg-slate-200 text-black hover:bg-purple-200"
                )}
              >
                {o}
              </button>
